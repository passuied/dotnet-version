...
namespace DotNet.Versioning.Tests
{
    public class VersionInfoFacts
    {
        ...
        public class TheUpMethod
        {
            ...
            [InlineData("1.0.1", VersionCommandType.Build, "1.0.1.1")]
            [InlineData("1", VersionCommandType.Build, "1.0.0.1")]
            [InlineData("1.1", VersionCommandType.Build, "1.1.0.1")]
            [InlineData("1.0.1.1", VersionCommandType.Build, "1.0.1.2")]
